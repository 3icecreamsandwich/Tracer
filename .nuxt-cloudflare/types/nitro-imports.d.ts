declare global {
  ...
  const WEB_AUTH_HANDOFF_COOKIE: typeof import('../../server/utils/web-auth-handoff').WEB_AUTH_HANDOFF_COOKIE
  const WEB_AUTH_HANDOFF_COOKIE_PATH: typeof import('../../server/utils/web-auth-handoff').WEB_AUTH_HANDOFF_COOKIE_PATH
  ...
  const allowLandingAuthOrigin: typeof import('../../server/utils/web-auth-handoff').allowLandingAuthOrigin
  ...
  const authenticatedWebClient: typeof import('../../server/utils/web-auth').authenticatedWebClient
  ...
  const readWebJson: typeof import('../../server/utils/web-body').readWebJson
  const readWebProviderKeys: typeof import('../../server/utils/web-auth').readWebProviderKeys
  ...
  const webBindings: typeof import('../../server/utils/web-config').webBindings
  const webRuntimeConfig: typeof import('../../server/utils/web-config').webRuntimeConfig
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/Users/xun-xia/Development/tracer/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/Users/xun-xia/Development/tracer/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { useAppConfig } from '/Users/xun-xia/Development/tracer/node_modules/@nuxt/nitro-server/dist/runtime/utils/app-config';
export { WEB_AUTH_HANDOFF_COOKIE, WEB_AUTH_HANDOFF_COOKIE_PATH, allowLandingAuthOrigin } from '/Users/xun-xia/Development/tracer/server/utils/web-auth-handoff';
export { authenticatedWebClient, readWebProviderKeys } from '/Users/xun-xia/Development/tracer/server/utils/web-auth';
export { readWebJson } from '/Users/xun-xia/Development/tracer/server/utils/web-body';
export { webBindings, webRuntimeConfig } from '/Users/xun-xia/Development/tracer/server/utils/web-config';