...
const detailMessages: Record<AppLanguage, Messages> = {
  en: {
    ...
    'set.synthesizedFrom': 'Synthesized from:', 'set.termLabel': 'Term:', 'set.definitionLabel': 'Definition:', 'set.filterTerms': 'Filter terms', 'set.filterAll': 'All', 'set.filterStarred': 'Starred', 'set.filterUnstarred': 'Unstarred',
  ...
  es: {
    ...
    'set.synthesizedFrom': 'Sintetizado a partir de:', 'set.termLabel': 'Término:', 'set.definitionLabel': 'Definición:', 'set.filterTerms': 'Filtrar términos', 'set.filterAll': 'Todos', 'set.filterStarred': 'Favoritos', 'set.filterUnstarred': 'No favoritos',
  ...
  fr: {
    ...
    'set.synthesizedFrom': 'Synthétisé à partir de :', 'set.termLabel': 'Terme :', 'set.definitionLabel': 'Définition :', 'set.filterTerms': 'Filtrer les termes', 'set.filterAll': 'Tous', 'set.filterStarred': 'Favoris', 'set.filterUnstarred': 'Non favoris',
  ...
  'zh-CN': {
    ...
    'set.synthesizedFrom': '综合自：', 'set.termLabel': '术语：', 'set.definitionLabel': '定义：', 'set.filterTerms': '筛选术语', 'set.filterAll': '全部', 'set.filterStarred': '已收藏', 'set.filterUnstarred': '未收藏',
  ...
  hi: {
    ...
    'set.synthesizedFrom': 'इनसे सिंथेसाइज़ किया गया:', 'set.termLabel': 'शब्द:', 'set.definitionLabel': 'परिभाषा:', 'set.filterTerms': 'शब्द फ़िल्टर करें', 'set.filterAll': 'सभी', 'set.filterStarred': 'पसंदीदा', 'set.filterUnstarred': 'गैर-पसंदीदा',
  ...
  ar: {
    ...
    'set.synthesizedFrom': 'مُولّف من:', 'set.termLabel': 'المصطلح:', 'set.definitionLabel': 'التعريف:', 'set.filterTerms': 'تصفية المصطلحات', 'set.filterAll': 'الكل', 'set.filterStarred': 'المفضلة', 'set.filterUnstarred': 'غير المفضلة',
  ...
  de: {
    ...
    'set.synthesizedFrom': 'Synthetisiert aus:', 'set.termLabel': 'Begriff:', 'set.definitionLabel': 'Definition:', 'set.filterTerms': 'Begriffe filtern', 'set.filterAll': 'Alle', 'set.filterStarred': 'Favoriten', 'set.filterUnstarred': 'Nicht favorisiert',
  ...
  ru: {
    ...
    'set.synthesizedFrom': 'Синтезировано из:', 'set.termLabel': 'Термин:', 'set.definitionLabel': 'Определение:', 'set.filterTerms': 'Фильтровать термины', 'set.filterAll': 'Все', 'set.filterStarred': 'Избранные', 'set.filterUnstarred': 'Неизбранные',
  ...
  ja: {
    ...
    'set.synthesizedFrom': '統合元：', 'set.termLabel': '用語：', 'set.definitionLabel': '定義：', 'set.filterTerms': '用語を絞り込む', 'set.filterAll': 'すべて', 'set.filterStarred': 'お気に入り', 'set.filterUnstarred': 'お気に入り以外',
  ...
  ko: {
    ...
    'set.synthesizedFrom': '통합 출처:', 'set.termLabel': '용어:', 'set.definitionLabel': '정의:', 'set.filterTerms': '용어 필터', 'set.filterAll': '전체', 'set.filterStarred': '즐겨찾기', 'set.filterUnstarred': '즐겨찾기 아님',
